...
api_token <- "api token"
list_body <- top_ten_emails

results <- POST("https://api.clearout.io/v2/email_verify/bulk", body = top_ten_emails, add_headers(Authorization = paste("Key", api_token)), encode = "multipart")
